...
function MoodRadar({ currentUser }) {
    ...
    return (
        <div className="stat-box">
            ...
            <p>
                This radar graph shows the average distribution of your energy each day compared to how much sleep you get. Most days you report feeling <strong>{maxSleepMood}</strong> and you're averaging a whopping <strong>{maxSleepHours}</strong> on those days! 
            </p>
